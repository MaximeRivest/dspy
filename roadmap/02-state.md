...
What exists right now and its load-bearing status. **Regenerate this page at the end of every epic.** Last updated: 2026-08-06, mid-Epic-D (after D-α, the adversarial review, and the review-fix fork; D-β next).
