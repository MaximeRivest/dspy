...
TODO(DSPy 3.5): remove this module after adapter types render through
normalized request patches instead of embedding provider-shaped JSON in prompt
text.
"""
...
from dspy.core.types import LMAudioPart, LMBinaryPart, LMDocumentPart, LMMessage, LMPart, LMTextPart
...
def _legacy_content_block_to_lm_part(block: Any) -> LMPart:
    ...
    if block_type == "file":
        ...
        return LMBinaryPart(file_id=file.get("file_id", ""), filename=file.get("filename"))
