...
class Module(BaseModule, metaclass=ProgramMeta):
    ...
    def set_adapter(self, adapter):
        ...
        contained within this module. Setting `None` restores the default
        resolution through `dspy.settings.adapter`.

        Args:
            adapter: The adapter instance to use for all predictors.
